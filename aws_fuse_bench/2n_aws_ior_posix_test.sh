#!/bin/sh
#SBATCH --job-name=2n_32p_aws_fuse_posix
...
DARSHAN_PATH="/qfs/people/$USER/experiments/darshan-logs/2025/7/29"
CWD="$(pwd)"
...
for np in "${np_list[@]}"; do
    for trial in 1 2 3; do  # Run each test 3 times {1..3}
        for ts_size in 4k 8k 1m 4m 100m; do # 8k 1m 4m 100m
            block_size="1000m" # 1000m 100m
            # ts_size=$block_size
